...
st.write("This is a simple file converter and cleaner tool. You can upload CSV or Excel File and convert it to a different format or clean it by removing duplicates and empty rows.")
...
if files:
    for file in files:
        ...
        if st.checkbox(f"📊 Show Chart - {file.name}") and not numeric_df.empty:
            ...
            st.warning(f"No numeric columns available to plot for {file.name}")
